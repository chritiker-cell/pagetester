...
export default function Navigation() {
  ...
  return (
    <nav aria-label="Hauptnavigation" className="bg-white dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700 shadow-sm">
              ...
              <button
                ...
                className={`
                  ...
                  ${isActive
                    ...
                    : isDisabled
                      ? 'text-neutral-400 dark:text-neutral-600 cursor-not-allowed opacity-60 border-transparent'
                      : 'text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-neutral-100 border-transparent'
                  }
                `.replace(/\s+/g, ' ').trim()}
              >
                {item.icon}
                ...
                {isDisabled && (
                  <span className="hidden md:inline text-xs text-neutral-300 dark:text-neutral-600 border border-neutral-200 dark:border-neutral-700 px-1.5 py-0.5 rounded-full">
                    Bald
                  </span>
                )}
              </button>
